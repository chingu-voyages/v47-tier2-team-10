  ...
  return (
    <div>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-6">
            ...
            {/* <!-- Card --> */}
            <a class="group flex gap-y-6 w-full h-full  bg-gray-100 shadow-md hover:bg-gray-50 rounded-lg p-5 transition-all dark:hover:bg-white/[.075] dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/">
