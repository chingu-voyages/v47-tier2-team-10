...
interface AddNewActivityProps {
  setIsNewActivityModalOpen: (value: boolean) => void;
  categoryName: string;
}

function AddNewActivity(props: AddNewActivityProps) {
  const { categoryName, setIsNewActivityModalOpen } = props;
